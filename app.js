function getWeather() {
    const apiKey = 'f0bae24bad82f32d1990053a30403490';
...
function displayWeather(data) {
    ...
    if (data.cod === '404') {
        ...
        const weatherHtml = `
            <p style="text-transform: capitalize">${cityName}</p>
...
function displayHourlyForecast(hourlyData) {
    ...
    const next24Hours = hourlyData.slice(0, 5); // Display the next 24 hours (5 intervals)
...
//allows for keyboard enter for search
